...
import { Brain, Search, Award, TrendingUp } from "lucide-react";

export default function ResearchHero() {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-teal-900 via-cyan-800 to-blue-900">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-black/30"></div>
      <div className="absolute top-0 left-0 w-96 h-96 bg-teal-400/20 rounded-full -translate-x-48 -translate-y-48 blur-3xl animate-pulse"></div>
      ...
      <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-blue-500/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-2xl animate-bounce"></div>
      ...
      <div className="container mx-auto px-6 mt-4 relative z-10 text-center text-white">
        ...
        >
          <div className="inline-block bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full mb-6 border border-white/20">
            <span className="text-teal-200 font-semibold flex items-center gap-2">
          ...
          <p className="text-xl md:text-2xl mb-8 text-teal-100 max-w-4xl mx-auto font-light">
            Pioneering research in AI, cybersecurity, software engineering, and
            emerging technologies
          </p>

          <div className="grid sm:grid-cols-2 mb-10 lg:grid-cols-4 gap-6 mt-12 max-w-5xl mx-auto">
            {[
              {
                icon: Brain,
                value: "6",
